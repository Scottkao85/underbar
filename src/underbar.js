  ...
  */
  ...
  _.some = function(collection, iterator) {
   ...
   /*
    ...
    return _.every(collection, function(el, index, collection){
      if(!!iterator(el) === true){
        result = true;
        return result;
      }else{
      ...
      */
    // TIP TO RUIN YOUR DAY: There's a very clever way to re-use every() here.
  };
  ...
  _.shuffle = function(array) { //[4, 5, 6]
